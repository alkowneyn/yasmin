...
<html lang="en">
 ...
 <div class="container">
	...
	<div class="col-lg-8 col-lg-offset-4 well">
	<div class="row">
        		...
        		<div class="row">
					<div class="col-sm-12 form-group">
								...
								<input type="text" name="gname" placeholder="Enter your Full Name Here.." class="form-control">
							</div>
						</div>					
						<div class="row">
							...
							<div class="col-sm-4 form-group">
								...
								<div class="control-group">
                                  <select id="rno" name="rno"  class="form-control">
                                    <?php
	...
	<div class="row">
				...
				<div class="row">
					<div class="<col-lg-7></col-lg-7> col-lg-offset-5">
					<div class="form-group">
					<button  type="submit" name="register" class="btn btn-lg btn-info">Rigester</button>	
								</div>
                </div>
                <!--<div class="col-sm-6 ">
                <button  type="reset" name="reset"  class="btn btn-md btn-info">Reset</button>
                </div>-->
				</div>
				</form> 
				</div>
